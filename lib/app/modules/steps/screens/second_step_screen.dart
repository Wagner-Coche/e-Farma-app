...
import '../components/second_step_components/image_center_second_step_component.dart';
...
class SecondStepScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Modular.get<SecondStepController>();
            ...
            child: Column(
              ...
              children: <Widget>[
                StepTextButtonWidget(
                  text: "Pular",
                  onTap: ()=> controller.goToThirdStepScreen()
                ),
                const ImageCenterSecondStepComponent(),
                ButtonNextStepWidget(onPressed: () => controller.goToThirdStepScreen()
                )
              ],
            ),
          ),
